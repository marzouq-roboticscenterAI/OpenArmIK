...
The module is diagnostics-only.  It contains no frame for zero-position flash,
register writes, CAN-ID/bitrate/mode changes, firmware flash, or automatic motor
enablement.
