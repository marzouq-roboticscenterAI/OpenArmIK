...
public:
  ...
  : Node("openarm_portal"), real_mode_(real_mode)
  {
    ...
    if (real_mode_) {
      ...
      real_flip_left_ = create_client<std_srvs::srv::Trigger>("/openarm_real/flip_left");
      real_flip_right_ = create_client<std_srvs::srv::Trigger>("/openarm_real/flip_right");
...
private:
  ...
  rclcpp::Client<std_srvs::srv::Trigger>::SharedPtr real_flip_left_;
  rclcpp::Client<std_srvs::srv::Trigger>::SharedPtr real_flip_right_;
